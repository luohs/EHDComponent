...
{
    EHDUIBus *bus = [[EHDUIBus alloc] init];
    return [bus openURL:URL transitionBlock:nil extraData:extraData completion:completion];
}
...
{
    EHDUIBus *bus = [[EHDUIBus alloc] init];
    return [bus open:componentName transitionBlock:nil extraData:extraData completion:completion];
}

// 自定义打开一个URL组件
- (id<EHDComponentRoutable>)openURL:(NSString *)URL
{
    return [self openURL:URL transitionBlock:nil extraData:nil completion:nil];
}
...
- (id<EHDComponentRoutable>)openURL:(NSString *)URL
                         ...
                         completion:(void (^)(id result))completion
{
    return [self openURL:URL transitionBlock:nil extraData:extraData completion:completion];
}
...
- (id<EHDComponentRoutable>)open:(NSString *)componentName
{
    return [self open:componentName transitionBlock:nil extraData:nil completion:nil];
}
...
- (id<EHDComponentRoutable>)open:(NSString *)componentName
                         ...
                         completion:(void (^)(id result))completion
{
    return [self open:componentName transitionBlock:nil extraData:extraData completion:completion];
}
